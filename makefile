...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  alarmGen.o codeCont.o counter.o doorTimer.o lightIn.o lightout.o register.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#B
...
#^|
alarmGen.o: /cygdrive/C/eclipse/workspace/bbgaragedoor/alarmGen.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
codeCont.o: /cygdrive/C/eclipse/workspace/bbgaragedoor/codeCont.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
counter.o: /cygdrive/C/eclipse/workspace/bbgaragedoor/counter.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
doorTimer.o: /cygdrive/C/eclipse/workspace/bbgaragedoor/doorTimer.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
lightIn.o: /cygdrive/C/eclipse/workspace/bbgaragedoor/lightIn.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
lightout.o: /cygdrive/C/eclipse/workspace/bbgaragedoor/lightout.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/bbgaragedoor/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
alarmGen.o: /cygdrive/C/eclipse/workspace/bbgaragedoor/alarmGen.cpp \
 /cygdrive/C/eclipse/workspace/bbgaragedoor/alarmGen.h \
...
codeCont.o: /cygdrive/C/eclipse/workspace/bbgaragedoor/codeCont.cpp \
 /cygdrive/C/eclipse/workspace/bbgaragedoor/codeCont.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
counter.o: /cygdrive/C/eclipse/workspace/bbgaragedoor/counter.cpp \
 /cygdrive/C/eclipse/workspace/bbgaragedoor/counter.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
doorTimer.o: /cygdrive/C/eclipse/workspace/bbgaragedoor/doorTimer.cpp \
 /cygdrive/C/eclipse/workspace/bbgaragedoor/doorTimer.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
lightIn.o: /cygdrive/C/eclipse/workspace/bbgaragedoor/lightIn.cpp \
 /cygdrive/C/eclipse/workspace/bbgaragedoor/lightIn.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
lightout.o: /cygdrive/C/eclipse/workspace/bbgaragedoor/lightout.cpp \
 /cygdrive/C/eclipse/workspace/bbgaragedoor/lightOut.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
...
register.o: /cygdrive/C/eclipse/workspace/bbgaragedoor/register.cpp \
 ...
 /cygdrive/C/eclipse/workspace/bbgaragedoor/alarmGen.h \
 /cygdrive/C/eclipse/workspace/bbgaragedoor/codeCont.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/queue.h \
